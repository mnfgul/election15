...
<div class="aday-list-row aday-list-row-block clearfix row b-b b-grey hover-highlight">
    ...
    <div class="col-text col-md-6 col-xs-6">
        ...
        <p class="x-small-text text-1-line"><span class="semi-bold"><?php print $fields['term_node_tid_1']->content;?></span> Milletvekili <?php print $fields['field_status']->content;?></span></p>
    </div>
